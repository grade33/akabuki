...
var classNames = {
  ...
  popups: {
    overlay: 'popup',
    overlayActive: 'popup_active',
    popup: 'popup__window',
    popupActive: 'popup__window_active'
  },
  swiper: {
    streamlining: {
...
function _defineProperty(obj, key, value) { key = swiper_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
